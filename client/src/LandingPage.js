...
const LandingPage = () =>
  <div className="LandingPage">
    <img className="LandingPage-title" src="images/BlockPartyLogo.png" alt="Block Party"></img>
    <p className="LandingPage-tagline">Live minigame competition against the world<br /><br />Coming soon to the web, iOS and Android</p>
